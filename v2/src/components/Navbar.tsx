...
function Navbar() {
  return (
    <>
      <nav className="fixed top-0 w-full flex justify-between items-center px-12 py-6 bg-transparent dark:bg-black/90 backdrop-blur-xl z-50 transition-all duration-300">
