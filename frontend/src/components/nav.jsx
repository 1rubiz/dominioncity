...
//                     exit={{ opacity: 0 }}
//                     >
//                     <div className='list-none text-[19px] w-full opacity-50 hover:opacity-90 flex justify-between items-center gap-5 pr-5 pl-5 font-bold text-[white]'>
...
//               <div className="flex justify-center items-center w-full mb-[2vh]">
//                 <Link to='/'><img
...
//                   <div className='w-full p-2 hover:bg-[#164863]'><a
//                     href="/"
...
//                   <div className='w-full p-2 hover:bg-[#164863]'>
//                   <a
//                     href="/media"
//                     className=" text-white flex items-center gap-6 border-b-2 border-[#164863] px-3 py-2 rounded-md text-[3.5vh] font-serif font-medium"
//                   >
